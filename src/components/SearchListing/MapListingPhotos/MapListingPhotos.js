...
const nextArrowStyle = {
  right: '4px',
  color: '#282828', zIndex: '0', width: '34px', height: '34px', top: '50%',
...
const prevArrowStyle = {
  left: '4px',
  color: '#282828', zIndex: '1', width: '34px', height: '34px', top: '50%',
  fontSize: '18px', cursor: 'pointer', textAlign: 'center', backgroundColor: '#fff',
  backgroundRepeat: 'repeat-x',
  ...
  return (
    ...
    >
      <svg viewBox="0 0 18 18" role="img" aria-label="Previous" focusable="false"
        style={{ height: '13px', width: '13px', display: 'block', fill: '#282828', position: 'absolute', top: '31%', right: '8px' }}>
...
function SamplePrevArrow(props) {
  ...
  return (
    ...
    >
      <svg viewBox="0 0 18 18" role="img" aria-label="Previous" focusable="false"
        style={{ height: '13px', width: '13px', display: 'block', fill: '#282828', position: 'absolute', top: '31%', left: '8px' }}>
...
class MapListingPhotos extends React.Component {
  ...
  render() {
    ...
    let imagepath = '/images/upload/x_medium_';
