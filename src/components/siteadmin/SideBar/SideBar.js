...
import siteSettingIcon from '/public/adminIcons/siteSetting.svg';
import manageAdminIcon from '/public/adminIcons/ManageAdmin.svg';
import manageAdminUserIcon from '/public/adminIcons/ManageUser.svg';
import manageListingIcon from '/public/adminIcons/manageListing.svg';
import listingRequestIcon from '/public/adminIcons/listingRequest.svg';
import manageRevertionIcon from '/public/adminIcons/manageReservation.svg';
import manageServiceFeeIcon from '/public/adminIcons/manageServiceFee.svg';
import managePayoutFeeIcon from '/public/adminIcons/mangePayoutIcon.svg';
import managePaymentIcon from '/public/adminIcons/managePaymentGatewayIcon.svg';
import manageCurrencyIcon from '/public/adminIcons/manageCurrencyIcon.svg';
import siteConfigIcon from '/public/adminIcons/siteConfig.svg';
import reviewManageIcon from '/public/adminIcons/reviewManage.svg';
import adminReviewsIcon from '/public/adminIcons/adminReviews.svg';
import documentVerifyIcon from '/public/adminIcons/documentVerification.svg';
import messageIcon from '/public/adminIcons/message.svg';
import reportManageIcon from '/public/adminIcons/reportManage.svg'
import cancelPolicy from '/public/adminIcons/cancel.svg';
import searchSetting from '/public/adminIcons/searchSetting.svg';
import changePwdIcon from '/public/adminIcons/changePwd.svg';
import homePageIcon from '/public/adminIcons/homepageSettings.svg';
import whyHostIcon from '/public/adminIcons/whyHost.svg';
import listSettings from '/public/adminIcons/listSetting.svg';
import contentIcon from '/public/adminIcons/contentIcon.svg';
import manageInquiryIcon from '/public/adminIcons/manageInquiryIcon.svg'
import staticContentIcon from '/public/adminIcons/staticContent.svg';
				...
				<div className={cx({ [s.menuOpen]: this.state.isOpen == 1 }, s.sidebarWrapper, 'adminScrollBar', 'bgBlackTwo')}>
					...
					<div className={cx("hidden-print", s.sidebarNavParent)}>
						...
						<ul className={s.sidebarNav}>
							...
							</li>
							{
								validatePrivilege(1, privileges) && <li className={cx({ [s.active]: location === '/siteadmin/settings/site' })}>
									<Link to={'/siteadmin/settings/site'} className={cx(s.sideNavitem, s.disPlayTable)} onClick={() => this.openClose()}>
										<span className={s.disPlayTabelCell}>
											<img src={siteSettingIcon} className={s.navigationIcon} />
										</span>
							...
							{
								validatePrivilege(20, privileges) && <li className={cx({ [s.active]: location === '/siteadmin/settings/siteConfiguration' })}>
									<Link to={'/siteadmin/settings/siteConfiguration'} className={cx(s.sideNavitem, s.disPlayTable)} onClick={() => this.openClose()}>
										<span className={s.disPlayTabelCell}>
											<img src={siteConfigIcon} className={cx(s.navigationIcon)} />
										</span>
										<span className={s.disPlayTabelCell}><FormattedMessage {...messages.manageSiteConfig} /></span>
									</Link>
								</li>
							}
							{
								isSuperAdmin && <>
									<div className={cx(adminManagementArray.includes(location) ? [s.active] : '')}>
										<Button
											...
											<span className={s.disPlayTabelCell}>
												<img src={manageAdminIcon} className={s.navigationIcon} />
											</span>
							...
							{
								validatePrivilege(2, privileges) && <li className={cx({ [s.active]: (location === "/siteadmin/users" || location.startsWith('/siteadmin/profile-view')) })}>
									<Link to={'/siteadmin/users'} className={cx(s.sideNavitem, s.disPlayTable)} onClick={() => this.openClose()}>
										<span className={s.disPlayTabelCell}>
											<img src={manageAdminUserIcon} className={s.navigationIcon} />
										</span>
...

							{
								validatePrivilege(3, privileges) && <li className={cx({ [s.active]: location === "/siteadmin/listings" })}>
									<Link to={'/siteadmin/listings'} className={cx(s.sideNavitem, s.disPlayTable)} onClick={() => this.openClose()}>
										<span className={s.disPlayTabelCell}>
											<img src={manageListingIcon} className={s.navigationIcon} />
										</span>
...

							{
								validatePrivilege(3, privileges) && listingApproval === '1' && <li className={cx({ [s.active]: location === "/siteadmin/listing-request" })}>
									<Link to={'/siteadmin/listing-request'} className={cx(s.sideNavitem, s.disPlayTable)} onClick={() => this.openClose()}>
										<span className={s.disPlayTabelCell}>
											<img src={listingRequestIcon} className={s.navigationIcon} />
										</span>
...

							{
								validatePrivilege(4, privileges) && <li className={cx({ [s.active]: (location === "/siteadmin/reservations" || location.startsWith('/siteadmin/viewreservation/')) })} >
									<Link to={'/siteadmin/reservations'} className={cx(s.sideNavitem, s.disPlayTable)} onClick={() => this.openClose()}>
										<span className={s.disPlayTabelCell}>
											<img src={manageRevertionIcon} className={s.navigationIcon} />
										</span>
							...
							{
								validatePrivilege(23, privileges) && <li className={cx({ [s.active]: (location === "/siteadmin/inquiry") })} >
									<Link to={'/siteadmin/inquiry'} className={cx(s.sideNavitem, s.disPlayTable)} onClick={() => this.openClose()}>
										<span className={s.disPlayTabelCell}>
											<img src={manageInquiryIcon} className={s.navigationIcon} />
										</span>
										<span className={s.disPlayTabelCell}><FormattedMessage {...messages.manageInquiry} /></span>
									</Link>
								</li>
							}

							{
								validatePrivilege(7, privileges) && <li className={cx({ [s.active]: location === '/siteadmin/settings/servicefees' })}>
									<Link to={'/siteadmin/settings/servicefees'} className={cx(s.sideNavitem, s.disPlayTable)} onClick={() => this.openClose()}>
										<span className={s.disPlayTabelCell}>
											<img src={manageServiceFeeIcon} className={s.navigationIcon} />
										</span>
...

							{
								validatePrivilege(17, privileges) && <li className={cx({ [s.active]: (location === '/siteadmin/payout' || location.startsWith('/siteadmin/viewpayout/')) })}>
									<Link to={'/siteadmin/payout'} className={cx(s.sideNavitem, s.disPlayTable)} onClick={() => this.openClose()}>
										<span className={s.disPlayTabelCell}>
											<img src={managePayoutFeeIcon} className={s.navigationIcon} />
										</span>
							...
							{ validatePrivilege(24, privileges) && <li className={cx({ [s.active]: location === '/siteadmin/payment-gateway-section' })}>
								<Link to={'/siteadmin/payment-gateway-section'} className={s.sideNavitem} onClick={() => this.openClose()}>
									<span className={s.disPlayTabelCell}>
										<img src={managePaymentIcon} className={s.navigationIcon} />
									</span>
									<span className={s.disPlayTabelCell}><FormattedMessage {...messages.managePaymentGateWay} /></span>
								</Link>
							</li>}

							{
								isSuperAdmin && <li className={cx({ [s.active]: location === '/siteadmin/currency' })}>
									<Link to={'/siteadmin/currency'} className={cx(s.sideNavitem, s.disPlayTable)} onClick={() => this.openClose()}>
										<span className={s.disPlayTabelCell}>
											<img src={manageCurrencyIcon} className={s.navigationIcon} />
										</span>
...

							{
								validatePrivilege(5, privileges) && <li className={cx({ [s.active]: (location === "/siteadmin/user-reviews" || location.startsWith('/siteadmin/management-reviews/')) })}>
									<Link to={'/siteadmin/user-reviews'} className={cx(s.sideNavitem, s.disPlayTable)} onClick={() => this.openClose()}>
										<span className={s.disPlayTabelCell}>
											<img src={reviewManageIcon} className={s.navigationIcon} />
										</span>
								...
								<>
									<div className={cx({ [s.active]: reviewManagementArray.includes(location) || location.startsWith('/siteadmin/reviews/edit-review/') })}>
										<Button
											...
											<span className={s.disPlayTabelCell}>
												<img src={adminReviewsIcon} className={s.navigationIcon} />
											</span>
...

							{
								validatePrivilege(8, privileges) && <li className={cx({ [s.active]: location === '/siteadmin/document' })}>
									<Link to={'/siteadmin/document'} className={cx(s.sideNavitem, s.disPlayTable)} onClick={() => this.openClose()}>
										<span className={s.disPlayTabelCell}>
											<img src={documentVerifyIcon} className={s.navigationIcon} />
										</span>
...

							{
								validatePrivilege(9, privileges) && <li className={cx({ [s.active]: location === '/siteadmin/messages' })}>
									<Link to={'/siteadmin/messages'} className={cx(s.sideNavitem, s.disPlayTable)} onClick={() => this.openClose()}>
										<span className={s.disPlayTabelCell}>
											<img src={messageIcon} className={s.navigationIcon} />
										</span>
							...
							}
							{
								validatePrivilege(10, privileges) && <li className={cx({ [s.active]: location === '/siteadmin/reportUser' })}>
									<Link to={'/siteadmin/reportUser'} className={cx(s.sideNavitem, s.disPlayTable)} onClick={() => this.openClose()}>
										<span className={s.disPlayTabelCell}>
											<img src={reportManageIcon} className={s.navigationIcon} />
										</span>
...

							{
								...
								<li className={cx({ [s.active]: location === '/siteadmin/cancellation-policies/management' || location.startsWith('/siteadmin/cancellation-policies/edit/') })}>
									<Link to={'/siteadmin/cancellation-policies/management'} className={cx(s.sideNavitem, s.disPlayTable)} onClick={() => this.openClose()}>
										<span className={s.disPlayTabelCell}>
											<img src={cancelPolicy} className={s.navigationIcon} />
										</span>
										<span className={s.disPlayTabelCell}><FormattedMessage {...messages.cancellationPolicyManagement} /></span>
									</Link>
								</li>
							}

							{
								validatePrivilege(11, privileges) && <li className={cx({ [s.active]: location === '/siteadmin/settings/search' })}>
									<Link to={'/siteadmin/settings/search'} className={cx(s.sideNavitem, s.disPlayTable)} onClick={() => this.openClose()}>
										<span className={s.disPlayTabelCell}>
											<img src={searchSetting} className={s.navigationIcon} />
										</span>
							...
							<li className={cx({ [s.active]: location === '/siteadmin/change/admin' })}>
								<Link to={'/siteadmin/change/admin'} className={cx(s.sideNavitem, s.disPlayTable)} onClick={() => this.openClose()}>
									<span className={s.disPlayTabelCell}>
										<img src={changePwdIcon} className={s.navigationIcon} />
									</span>
							...
							{
								(validatePrivilege(12, privileges) || validatePrivilege(13, privileges)) && <>
									<div className={cx(
										...
										<Button
											...
											<span className={s.disPlayTabelCell}>
												<img src={homePageIcon} className={s.navigationIcon} />
											</span>
							...
							}
							{
								...
								<li className={cx({ [s.active]: location === '/siteadmin/why-host' })}>
									<Link to={'/siteadmin/why-host'} className={cx(s.sideNavitem, s.disPlayTable)} onClick={() => this.openClose()}>
										<span className={s.disPlayTabelCell}>
											<img src={whyHostIcon} className={s.navigationIcon} />
										</span>
										<span className={s.disPlayTabelCell}><FormattedMessage {...messages.whyHostPage} /></span>
									</Link>
								</li>
							}
								...
								validatePrivilege(16, privileges) && <>
									...
									<Collapse in={this.state.whyHost} className={s.subMenu}>
										<div>
											...
											<li className={cx({ [s.active]: location === '/siteadmin/whyHost/review' || location.startsWith('/siteadmin/whyHost/review/add') })}>
												<Link to={'/siteadmin/whyHost/review'} className={cx(s.sideNavitem, s.disPlayTable)} onClick={() => this.openClose()}>
													<span className={s.disPlayTabelCell}>
														<FontAwesome.FaArrowRight className={cx(s.navigationIcon, 'sideArrowRTL')} />
													</span>
								...
								validatePrivilege(14, privileges) && <>
									<div className={cx(
										...
										<Button
											...
											<span className={s.disPlayTabelCell}>
												<img src={listSettings} className={s.navigationIcon} />
											</span>
										...
										<div>
											...
											<li className={cx({ [s.active]: location === '/siteadmin/listsettings/6' })}>
												<Link to={'/siteadmin/listsettings/6'} className={cx(s.sideNavitem, s.disPlayTable)} onClick={() => this.openClose()}>
													...
													<span className={s.disPlayTabelCell}><FormattedMessage {...messages.bedsCapital} /></span>
												</Link>
											</li>
							...
							}
							{
								validatePrivilege(15, privileges) && <li className={cx({ [s.active]: (location === '/siteadmin/content-management' || location.startsWith('/siteadmin/edit/page/') || location.startsWith('/siteadmin/page/add')) })}>
									<Link to={'/siteadmin/content-management'} className={cx(s.sideNavitem, s.disPlayTable)} onClick={() => this.openClose()}>
										<span className={s.disPlayTabelCell}>
											<img src={contentIcon} className={s.navigationIcon} />
										</span>
							...
							}
							{
								validatePrivilege(15, privileges) && <li className={cx({ [s.active]: (location === '/siteadmin/staticpage/management' || location.startsWith('/siteadmin/edit/staticpage/')) })}>
									<Link to={'/siteadmin/staticpage/management'} className={cx(s.sideNavitem, s.disPlayTable)} onClick={() => this.openClose()}>
										<span className={s.disPlayTabelCell}>
											<img src={staticContentIcon} className={s.navigationIcon} />
										</span>
