...
class BookingExpiredGuest extends Component {
	...
	render() {
		...
		const { content: { guestName, listTitle, confirmationCode, checkIn, logo, siteName } } = this.props;
							...
							<TR>
								<TD style={textStyle}>
									...
									<div>
										...
										{' '}{confirmationCode} starting on {checkInDate} has been expired. You will be fully refunded and notified.
									</div>
