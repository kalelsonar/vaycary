...
const ThreadItems = Model.define('ThreadItems', {
    ...
    type: {
        type: DataType.ENUM('message', 'inquiry', 'preApproved', 'declined', 'approved', 'pending', 'cancelledByHost', 'cancelledByGuest', 'intantBooking', 'requestToBook', 'confirmed', 'expired', 'completed', 'instantBooking'),
    ...
    status: {
        type: DataType.ENUM('inquiry', 'preApproved', 'booked'),
        defaultValue: null,
    }
});
