...
import {
    Listing, UserProfile, Threads, Payout, TransactionHistory, Transaction, CancellationDetails,
    User, ThreadItems, Cancellation, ReservationSpecialPricing, FailedTransactionHistory
} from '../models';
...
const ReservationType = new ObjectType({
    ...
    fields: {
        ...
        isHold: { type: BooleanType },
        paymentAttempt: { type: IntType },
        messageData: {
            type: ThreadsType,
            resolve(reservation) {
