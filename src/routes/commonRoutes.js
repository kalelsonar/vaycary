...
export const commonRoutes = [
  ...
  {
    path: '/siteadmin/settings/siteConfiguration',
    load: () => import(/* webpackChunkName: 'siteadmin-siteConfiguration' */ './siteadmin/siteConfiguration'),
  },
  {
  ...
  {
    path: '/siteadmin/profile-view/:profileId?',
  ...
  },
  {
    ...
    load: () => import(/* webpackChunkName: 'siteadmin-whyHostreview' */ './siteadmin/whyHostPageSettings/adminReviews'),
  },
  {
  ...
  },
  {
    ...
    load: () => import(/* webpackChunkName: 'siteadmin-editReviews' */ './siteadmin/whyHostPageSettings/editReviews'),
  },
  {
    path: '/siteadmin/whyHost/review/add',
    load: () => import(/* webpackChunkName: 'siteadmin-addReviews' */ './siteadmin/whyHostPageSettings/addReviews'),
  },
  {
  ...
  },
  {
    ...
    load: () => import(/* webpackChunkName: 'why-host' */ './siteadmin/whyHost'),
  },
  ...
  {
    path: '/siteadmin/cancellation-policies/management',
    load: () => import(/* webpackChunkName: 'cancellation-policies' */ './siteadmin/cancellationPolicies'),
  },

  {
    path: '/siteadmin/cancellation-policies/edit/:id?',
    load: () => import(/* webpackChunkName: 'edit-cancellation-policies' */ './siteadmin/cancellationPolicies/editCancelPolicy'),
  },
